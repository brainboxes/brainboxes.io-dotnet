    ...
    public class RemoteIO
    {
        ...
        private void demoTimerCallback(object p)
        {
            ...
            try
            {
                ...
                double waterTemp = Convert.ToDouble((inputStatus.Substring(42, 7))); //y = 26x -280y +1775
                state.waterTemp = ((waterTemp * 280) -1775) / 26; //26y = 280x - 1775
                // room temp = 22 degrees, 11mA, cold water = 16 degrees, 8mA, guess 1mA = 2 degrees C
            }
            catch (Exception e)
            {
